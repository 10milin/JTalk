            ...
            <div class="col-md-12">
              <table class="table table-condensed table-hover">
                ...
                <tr class="board-content board-white">
                	<td>
                		<i class="fa fa-user"></i> <a href="javascript:showmember('${life.writerId}')">${life.writerName}</a><span style="margin:0 10px;"></span>
                		<fmt:formatDate var="date" value="${life.writeDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
                		<i class="fa fa-clock-o"></i> ${date}<span style="margin:0 10px;"></span>
                		<i class="fa fa-eye"></i> ${life.hit}
                	</td>
                </tr>
                ...
                <c:if test="${not empty life.fileName}">
                <tr class="board-white">
                	<td>
                		<div class="col-md-4 col-sm-4 col-xs-12" style="padding:10px 0px;">
			                  <div class="mailbox-attachment-info">
			                    <span class="mailbox-attachment-name"><i class="fa fa-paperclip"></i> ${life.originFileName}</span>
			                          <a href="javascript:actiondownload('life.action?command=download','${life.fileName}', '${life.originFileName}');" class="btn btn-default btn-xs pull-right"><i class="glyphicon glyphicon-download-alt"></i></a>
			                  </div>
                		</div>
                	</td>
                </tr>
		                ...
		                <div class="comment-text">
		                      <span class="username">
		                        ...
		                        <c:if test="${item.writerId eq member.email || member.active ge 2}">
			                        <span class="margin-right-left"><a class="color-black" onclick="actioncmtdelete('comment.action?command=delete', 'life', ${item.num});" style="cursor:pointer;"><i class="fa fa-trash"></i></a></span>
		                        </c:if>                   
              ...
              <form action="/JTalk/comment.action?command=write" method="post">
                ...
                <div class="img-push input-group">
                  <input type="hidden" name = "tableName" value = "life"/>
                  <input type="hidden" name = "postNum" value = "${life.num}"/>
              ...
              <div class="text-right">
              	...
              	<c:if test="${member.email == life.writerId}">
	              	<button type="button" class="btn btn-default" onclick="actionparam('life.action?command=modifyform',${life.num});"><i class="fa fa-pencil"></i> 수정</button>
              	</c:if>
              	<c:if test="${member.email == life.writerId || member.active ge 2}">
              		<button type="button" class="btn btn-default" onclick="actionparam('life.action?command=delete',${life.num});"><i class="fa fa-trash"></i> 삭제</button>
              	</c:if>
              </div>
            </div>
            <!-- /.box-body -->
