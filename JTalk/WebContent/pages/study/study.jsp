	    ...
	    <div class="row">
            ...
            <div class="box-body box-body-padding">
                	...
                	<c:forEach var="item" items="${currentList}" varStatus="status">
                		<tr class="table-field">
		                  ...
		                  <td class="td-title">
							  ...
							  <fmt:formatDate value="${item.closingDate}" pattern="yyyy-MM-dd" var="closing_dt"/>
              ...
              <div class="text-right table-bottom">
              	<form action = "/JTalk/study.action?command=study" method="post">
              ...
              <div class="col-md-9 col-xs-12 text-right no-padding">
                	...
                	<button type="button" class="btn btn-default" onclick="actionlink('study.action?command=writeform');"><i class="fa fa-edit"></i> 쓰기</button>
	              	
              	</div>
              </div>
              <div class="col-md-12 text-center" style="display:inline-block; width:100%">
              	<form action="/JTalk/study.action?command=study" method="post" id="pagination-form">
