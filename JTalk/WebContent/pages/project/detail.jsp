            ...
            <div class="col-md-12">
              <table class="table table-condensed table-hover">
                <tr class="table-field board-headline">
                	...
                	<fmt:formatDate value="${project.writeDate}" pattern="yyyy-MM-dd" var="write_dt"/>
                  <th>
                  [${project.period}기] [${project.category}] ${project.title} 
                  </th>
                </tr>
                <tr class="board-content board-white">
                	<td>
                		<i class="fa fa-user"></i> <a href="javascript:showmember('${project.writerId}')">${project.writerName}</a><span style="margin:0 10px;"></span>
                		<fmt:formatDate var="date" value="${project.writeDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
                		<i class="fa fa-clock-o"></i> ${date}<span style="margin:0 10px;"></span>
                		<i class="fa fa-eye"></i> ${project.hit}
                	</td>
                </tr>
                <tr class="board-white">
                	<td>
                		<div class="moreinformation">
                			<i class="fa fa-star" style="width:14px; height:16px;"></i> 팀명 - ${project.teamName}<br>
                			<i class="fa fa-group" style="width:14px; height:16px;"></i> 팀원이름 - ${project.teamMember}<br>
                			<i class="fa fa-calendar" style="width:14px; height:16px;"></i> 프로젝트 기간 - ${project.closingDate}
                		</div>
                	</td>
                </tr>
                <tr class="board-white">
                	...
                	<td>
                		<div class="col-md-4 col-sm-4 col-xs-12" style="padding:10px 0px;">
			                  <div class="mailbox-attachment-info">
			                    <span class="mailbox-attachment-name"><i class="fa fa-paperclip"></i> ${project.originFileName}</span>
			                          <a href="javascript:actiondownload('project.action?command=download','${project.fileName}', '${project.originFileName}');" class="btn btn-default btn-xs pull-right"><i class="glyphicon glyphicon-download-alt"></i></a>
			                  </div>
                		</div>
                	</td>
                </tr>
		                ...
		                <div class="comment-text">
		                      <span class="username">
		                        ...
		                        <c:if test="${item.writerId eq member.email || member.active ge 2}">
			                        <span class="margin-right-left"><a class="color-black" onclick="actioncmtdelete('comment.action?command=delete', 'project', ${item.num});" style="cursor:pointer;"><i class="fa fa-trash"></i></a></span>
		                        </c:if>                   
              ...
              <form action="/JTalk/comment.action?command=write" method="post">
                ...
                <div class="img-push input-group">
                  ...
                  <input type="hidden" name = "postNum" value = "${project.num}"/>
              ...
              <div class="text-right">
              	...
              	<c:if test="${member.email == project.writerId}">
	              	<button type="button" class="btn btn-default" onclick="actionparam('project.action?command=modifyform',${project.num});"><i class="fa fa-pencil"></i> 수정</button>
              	</c:if>
              	<c:if test="${member.email == project.writerId || member.active ge 2}">
              		<button type="button" class="btn btn-default" onclick="actionparam('project.action?command=delete',${project.num});"><i class="fa fa-trash"></i> 삭제</button>
              	</c:if>
              </div>
            </div>
            <!-- /.box-body -->
