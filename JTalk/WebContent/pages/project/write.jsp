  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	    <div class="row">
            ...
            <form action = "/JTalk/project.action?command=write" method="post" enctype="multipart/form-data" onsubmit="return categorycheck(this);">
            <div class="box-body">
              <div>
              	  <div class="input-group input-margin-btm">
	                <span class="input-group-addon"><i class="glyphicon glyphicon-text-size"></i></span>
	                <input type="text" class="form-control" placeholder="프로젝트명" name="title" required>
	              ...
	              <div class="input-group input-margin-btm">
	                ...
	                <input type="text" class="form-control" placeholder="팀명" name="teamName" required>
	              </div>
	              <div class="input-group input-margin-btm">
	                <span class="input-group-addon"><i class="fa fa-group" style="width:14px; height:16px;"></i></span>
	                <input type="text" class="form-control" placeholder="팀원이름" name="teamMember" required>
	              </div>
	              <div class="input-group input-margin-btm">
	                <span class="input-group-addon"><i class="fa fa-calendar" style="width:14px; height:16px;"></i></span>
	                <input type="text" class="form-control pull-right" name="closingDate" id="reservation" required placeholder="프로젝트 기간">
	              </div>
