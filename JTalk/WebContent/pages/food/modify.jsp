	    ...
	    <div class="row">
            ...
            <div class="box-body">
              <div>
	                ...
	                <input type="text" class="form-control" placeholder="제목" name="title" value="<c:out value="${food.title}"/>" required>
	                ...
	                <input type="hidden" name="num" value="<c:out value="${food.num}"/>">
	              </div>
	              <div class="input-group input-margin-btm">
	                <span class="input-group-addon"><i class="fa fa-map-marker" style="width:14px; height:16px"></i></span>
	                <input id="address" type="text" class="form-control" placeholder="주소" name="address" value="<c:out value="${food.address}"/>" required>
	              ...
	              <div class="input-group col-md-4">
	                ...
	                <input id = "uploadfield" value="<c:out value="${food.fileName}"/>" type="text" class="form-control" readonly>
