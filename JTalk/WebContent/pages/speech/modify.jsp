  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	    <div class="row">
            ...
            <form action = "/JTalk/speech.action?command=modify" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div>
              	<div class="input-group input-margin-btm">
	                <span class="input-group-addon"><i class="glyphicon glyphicon-text-size"></i></span>
	                <input type="text" class="form-control" placeholder="제목" name="title" required value="${speech.title}">
	                <input type="hidden" name="writerId" value="${member.email}">
	                <input type="hidden" name="writerName" value="${member.name}">
	                <input type="hidden" name="period" value="${speech.period}">
	                <input type="hidden" name="num" value="${speech.num}">
	              </div>
	              <textarea class="summernote" name="content" required>${speech.content}</textarea>
	              <div class="input-group col-md-4">
					<span class="input-group-addon"><i class="fa fa-upload"></i></span>
	                <input id = "uploadfield" value="${speech.fileName }" type="text" class="form-control" readonly>
