	    ...
	    <div class="row">
            ...
            <div class="box-body">
              <div>
	                ...
	                <input type="text" class="form-control" placeholder="제목" name="title" value="${it.title}" required>
	              ...
	              <div class="input-group col-md-4">
	                ...
	                <input id = "uploadfield" value="${it.fileName }" type="text" class="form-control" readonly>
