  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	    <div class="row">
            ...
            <form action = "/JTalk/it.action?command=modify" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div>
              	  <div class="input-group">
	                <span class="input-group-addon"><i class="glyphicon glyphicon-text-size"></i></span>
	                <input type="text" class="form-control" placeholder="제목" name="title" value="<c:out value="${it.title}"/>" required>
	                ...
	                <input type="hidden" name="num" value="<c:out value="${it.num}"/>">
	              </div>
	              <br>
	              <textarea class="summernote" name="content" required>${it.content}</textarea>
	              <div class="input-group col-md-4">
					<span class="input-group-addon"><i class="fa fa-upload"></i></span>
	                <input id = "uploadfield" value="<c:out value="${it.fileName}"/>" type="text" class="form-control" readonly>
