	    ...
	    <div class="row">
            ...
            <div class="box-body box-body-padding">
                ...
                <c:if test="${not empty currentList}">
                	...
                	<c:forEach var="item" items="${currentList}" varStatus="status">
                		<tr class="table-field">
		                  ...
		                  <td class="td-title">
		                  	  <a class="atag-black" href="javascript:actionparam('it.action?command=detail', '<c:out value="${item.num}"/>')"><c:out value="${item.title}"/></a>
              ...
              <div class="text-right table-bottom">
              	<form action = "/JTalk/it.action?command=it" method="post">
              ...
              <div class="col-md-9 col-xs-12 text-right no-padding">
                	...
                	<button type="button" class="btn btn-default" onclick="actionlink('it.action?command=writeform');"><i class="fa fa-edit"></i> 쓰기</button>
	              	
              	</div>
              </div>
              <div class="col-md-12 text-center" style="display:inline-block; width:100%">
              	<form action="/JTalk/it.action?command=it" method="post" id="pagination-form">
