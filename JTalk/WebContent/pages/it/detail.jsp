            ...
            <div class="col-md-12">
                	...
                	<td>
                		<div class="col-md-4 col-sm-4 col-xs-12" style="padding:10px 0px;">
			                  <div class="mailbox-attachment-info">
			                    <span class="mailbox-attachment-name"><i class="fa fa-paperclip"></i> ${it.originFileName}</span>
			                          <a href="javascript:actiondownload('it.action?command=download','${it.fileName}', '${it.originFileName}');" class="btn btn-default btn-xs pull-right"><i class="glyphicon glyphicon-download-alt"></i></a>
			                  </div>
                		</div>
                	</td>
                </tr>
		                ...
		                <div class="comment-text">
		                      <span class="username">
		                        ...
		                        <c:if test="${item.writerId eq member.email || member.active ge 2}">
			                        <span class="margin-right-left"><a class="color-black" onclick="actioncmtdelete('comment.action?command=delete', 'it', ${item.num});" style="cursor:pointer;"><i class="fa fa-trash"></i></a></span>
		                        </c:if>                   
              ...
              <form action="/JTalk/comment.action?command=write" method="post">
                ...
                <div class="img-push input-group">
                  ...
                  <input type="hidden" name = "postNum" value = "${it.num}"/>
              ...
              <div class="text-right">
              	...
              	<c:if test="${member.email == it.writerId}">
	              	<button type="button" class="btn btn-default" onclick="actionparam('it.action?command=modifyform',${it.num});"><i class="fa fa-pencil"></i> 수정</button>
              	</c:if>
              	<c:if test="${member.email == it.writerId || member.active ge 2}">
              		<button type="button" class="btn btn-default" onclick="actionparam('it.action?command=delete',${it.num});"><i class="fa fa-trash"></i> 삭제</button>
              	</c:if>
              </div>
            </div>
            <!-- /.box-body -->
