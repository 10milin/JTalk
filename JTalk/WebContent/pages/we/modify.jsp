  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	    <div class="row">
            ...
            <form action = "/JTalk/we.action?command=modify" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div>
              	  <div class="input-group">
	                <span class="input-group-addon"><i class="glyphicon glyphicon-text-size"></i></span>
	                <input type="text" class="form-control" placeholder="제목" name="title" value="${we.title}" required>
	                <input type="hidden" name="writerId" value="${member.email}">
	                <input type="hidden" name="writerName" value="${member.name}">
	                <input type="hidden" name="period" value="${we.period}">
	                <input type="hidden" name="num" value="${we.num}">
	              </div>
	              <br>
	              <textarea class="summernote" name="content" required>${we.content}</textarea>
	              <div class="input-group col-md-4">
					<span class="input-group-addon"><i class="fa fa-upload"></i></span>
	                <input id = "uploadfield" value="${we.fileName }" type="text" class="form-control" readonly>
