  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	    <div class="row">
            ...
            <form action = "/JTalk/exchange.action?command=modify" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div>
              	<div class="input-group input-margin-btm">
	                <span class="input-group-addon"><i class="glyphicon glyphicon-text-size"></i></span>
	                <input type="text" class="form-control" placeholder="제목" name="title" required value="<c:out value="${exchange.title}"/>">
	                ...
	                <input type="hidden" name="period" value="<c:out value="${exchange.period}"/>">
	                <input type="hidden" name="num" value="<c:out value="${exchange.num}"/>">
	              </div>
	              <div class="input-group input-margin-btm">
	                ...
	                <select id="category" class="form-control" name="category" required>
                 	 ...
                 	 <c:set var="category" value="'${exchange.category}'"/>
	              </div>
	              <textarea class="summernote" name="content" required>${exchange.content}</textarea>
	              <div class="input-group col-md-4">
					<span class="input-group-addon"><i class="fa fa-upload"></i></span>
	                <input id = "uploadfield" value="<c:out value="${exchange.fileName}"/>" type="text" class="form-control" readonly>
