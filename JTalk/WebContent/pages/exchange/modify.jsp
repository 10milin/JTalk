            ...
            <div class="box-body">
              <div>
              	<div class="input-group input-margin-btm">
	                ...
	                <input type="text" class="form-control" placeholder="제목" name="title" required value="${exchange.title}">
	                <input type="hidden" name="writerId" value="${member.email}">
	                <input type="hidden" name="writerName" value="${member.name}">
	                <input type="hidden" name="period" value="${exchange.period}">
	                <input type="hidden" name="num" value="${exchange.num}">
	              </div>
	              <div class="input-group input-margin-btm">
	              ...
	              <div class="input-group col-md-4">
	                ...
	                <input id = "uploadfield" value="${exchange.fileName }" type="text" class="form-control" readonly>
