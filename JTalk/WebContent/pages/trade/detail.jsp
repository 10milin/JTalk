                ...
                <tr class="board-white">
                	<td>
                		<div class="moreinformation">
                			<c:if test="${trade.isSoldout eq '0'}">
					          <c:set var="phone" value="${trade.phone}"></c:set>
					         </c:if>
					         <c:if test="${trade.isSoldout eq '1'}">
					         	<c:set var="phone" value="***"></c:set>
					         </c:if> 
                			<i class="glyphicon glyphicon-earphone" style="width:14px; height:16px;"></i> 연락처 ${phone}<br>
                			<i class="fa fa-krw" style="width:14px; height:16px;"></i> 판매가격 <fmt:formatNumber value="${trade.price}" pattern="#,###" />원<br>
                			<div class="text-center marginbt"><a class="example-image-link" href="/JTalk/upload/${trade.photo}" data-lightbox="example-1"><img class="example-image img-thumbnail img-responsive" src="/JTalk/upload/${trade.photo}" alt="image-1" width="300px"/></a></div>
